...
def contact():
    if(request.method=='POST'):
        ...
        db.session.commit()
        flash("Thank you for contacting, I will get back to you soon.", "success")

        #to get notified if anyone has filled contact form
        #remove the comment and in config.hson file add your email address
        #and make ssure that your email setting has allowed third party messages
